...
const addEventListenerCart = () => {
 //closing the drawer when clicked on close button
 document.querySelector(".cart-drawer .cart-drawer-header-right-close").
...
window.cartEvents = addEventListenerCart;
...
//open cart drawer when clicked on cart icon
